/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 52672b9e73a38037278246438673c783)
// Runtime types generated with workerd@1.20260918.1 2026-09-01 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	DATABASE_URL: string;
	CODIGO_PEPPER: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "CODIGO_PEPPER" | "SESSION_SECRET" | "ADMIN_SENHA">> {}
}
